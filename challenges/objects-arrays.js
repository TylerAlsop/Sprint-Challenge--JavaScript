...
*/
const displayNames = [];
displayNames.push(zooAnimals.forEach(function(obj){
...
const lowCaseAnimalNames = zooAnimals.map(function(obj){
...
*/
const lowPopulationAnimals = zooAnimals.filter(function (obj){
...
*/
const populationTotal = function addUpPopulations(zooAnimals){
  function sum(accum, zooAnimal){
    return accum + zooAnimal.population;
  };
